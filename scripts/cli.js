...
const contractABI = require("../artifacts/contracts/Monitorprism.sol/Monitorprism.json").abi;

program
    .name("monitorprism-cli")
    .description("CLI tool for Monitorprism smart contract")
    .version("1.0.0");

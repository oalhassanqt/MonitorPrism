 ...
 * This file demonstrates how to integrate Monitorprism with a web frontend
 */

// For React/Vue/Angular applications
export class MonitorprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MonitorprismClient(provider, contractAddress);
